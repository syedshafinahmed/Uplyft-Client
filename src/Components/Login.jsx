...
const Login = () => {
  ...
  return (
    <div className="hero bg-base-200 min-h-screen">
      <div data-aos="fade-up" className="card bg-violet-100 border-2 border-indigo-800 w-full max-w-sm shrink-0 shadow-2xl">
        <div className="card-body">
          ...
          <fieldset className="fieldset">
            ...
            <button className="btn text-base border border-indigo-800 text-indigo-800 mt-3 rounded-full">

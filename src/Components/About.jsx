...
//         {/* Floating Stats */}
//         <div className="absolute -bottom-24 md:-bottom-16 left-1/2 -translate-x-1/2 w-full px-4 max-w-7xl grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 z-20">
...
//               className="bg-base-100 dark:bg-gray-900 p-6 rounded-xl hidden  sm:block md:block shadow-2xl text-center"
//             >
  ...
  return (
    <div className="min-h-screen bg-base-200 pb-32 relative">
      ...
      <div className="relative w-full h-[50vh] md:h-[60vh]">
        ...
        <h1 className="absolute inset-0 flex items-center justify-center text-3xl sm:text-4xl md:text-6xl font-black text-white z-10 text-center px-4">
          About Uplyft
        </h1>
...
const AboutSkeleton = () => (
  <div className="min-h-screen bg-base-200 animate-pulse">
    ...
    <div className="-mt-24 px-4 max-w-7xl mx-auto flex md:grid md:grid-cols-4 gap-4 overflow-x-auto">
      {[...Array(4)].map((_, i) => (
        <div key={i} className="h-28 min-w-[240px] md:min-w-0 bg-gray-300 dark:bg-gray-700 rounded-xl" />
      ))}
    </div>
